...
namespace StegoPlusPlus.Controls
{
    class Data
    {
        ...
        public static class Misc
        {
            ...
            public static readonly string ToastGroupA = "ToastGroupA";
            public static readonly string ToastGroupB = "ToastGroupB";

            public static readonly string T_Extract = "Extracting";
            public static readonly string T_Embed = "Embedding";
            public static readonly string T_Encrypt = "Encrypting";
            public static readonly string T_Decrypt = "Decrypting";
            public static readonly string T_ConvertBinary = "Converting to Binary";
